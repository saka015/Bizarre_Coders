...
const Card = (props) => {
  return (
    <div className='bg-slate-600 h-72 w-72 mx-24 my-16 py-2 shadow-lg shadow-slate-300'>
    <img src={props.img} alt="" className='h-48 w-48 mx-10 my-4 rounded-full ' />
    <h1 className='animate-pulse text-white text-lg font-semibold text-center font-mono'>{props.name}</h1>
